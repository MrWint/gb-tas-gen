...
//		seq(Segment.scrollA(2)); // switch
//		seq(Segment.scrollA(-2)); // ditto
//		seq(Move.B);
//		seq(Segment.scrollA(1)); // items
//		seq(Segment.scroll(7)); // Dig
...
//		seq(new EncounterAndCatchSegment(143, Move.UP)); // Weezing
...
//		}
////		seq(new EncounterAndCatchSegment(163, Move.UP)); // Ponyta
//		seq(new WalkToSegment(7, 13));
...
//		seq(Segment.scroll(7)); // rare candy

...
//		seq(new WalkStep(Move.DOWN, true));
//		seq(new WalkStep(Move.DOWN, true));
//		seq(new EncounterAndCatchSegment(new CheckEncounterMetric(24, 30, 35, 40), Move.DOWN)); // Tentacool
//		seq(new WalkStep(Move.RIGHT, true));
//		seq(new WalkStep(Move.RIGHT, true));
//		seq(new WalkToSegment(8, 3));
//		seq(new EncounterAndCatchSegment(new CheckEncounterMetric(150, 32), Move.DOWN)); // Pidgeotto L32
//		seq(new WalkToSegment(8, 6));
//		seq(new EncounterAndCatchSegment(36, Move.DOWN)); // Pidgey
//		seq(new WalkToSegment(8, 5));
//		seq(new EncounterAndCatchSegment(165, Move.UP)); // Rattata
//		seq(new WalkToSegment(8, 6));
//		seq(new EncounterAndCatchSegment(166, Move.DOWN)); // Raticate
//		seq(new WalkToSegment(8, 5));
//		seq(new EncounterAndCatchSegment(30, Move.UP)); // Tangela
//	
//		seq(Segment.repress(Move.START));
//		seq(Segment.scrollA(1)); // mons
//		seq(Segment.scrollA(1)); // mew
...
//		load("om2");
//
//		seq(new WalkToSegment(19, 6)); // old man
...
//		seq(new WalkToSegment(5, 4)); // room
//		seq(new WalkToSegment(5, 3)); // room

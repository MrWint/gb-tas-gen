...
//		seq(new FishAndCatchSegment(110, 2, 0)); // Poliwhirl
...
//		seq(new EncounterAndCatchSegment(47, Move.UP)); // Psyduck
//		seq(new WalkToSegment(25, 14));
//		seq(new EncounterAndCatchSegment(128, Move.LEFT)); // Golduck
//		seq(new WalkToSegment(23, 15)); // B1F
//		seq(new WalkToSegment(25, 15));
...
//		seq(new WalkToSegment(24, 12));
//		seq(new EncounterAndCatchSegment(8, Move.DOWN)); // Slowbro
//		seq(new WalkToSegment(25, 14)); // B3F
//		seq(new WalkToSegment(25, 12));
//		seq(new EncounterAndCatchSegment(93, Move.UP)); // Seadra
//		seq(new WalkToSegment(25, 9));
//		seq(new EncounterAndCatchSegment(58, Move.UP)); // Seel
//		seq(new Move() {
//			@Override public int getInitialKey() { return 0; }
//			@Override
//			public boolean doMove() {
...
//		seq(new WalkStep(Move.RIGHT, true));
//		seq(new WalkStep(Move.RIGHT, true));
//		seq(new EncounterAndCatchSegment(23, Move.RIGHT)); // Shellder
...
//		save("si8");
		...
		seq(new WithdrawMonSegment(4)); // Shellder
		seq(new WithdrawMonSegment(10)); // Staryu

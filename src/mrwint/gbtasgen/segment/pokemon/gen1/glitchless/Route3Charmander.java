...
public class Route3Charmander extends SeqSegment {
...
//			kems.attackCount[2][0] = 2; // 2x ember
//			kems.numExpGainers = 1; // no level up
//			kems.onlyPrintInfo = false;
//			seq(kems); // Rattata
//		}
...
//			kems.attackCount[2][0] = 2; // 1x ember
//			kems.numExpGainers = 1; // no level up
//			kems.onlyPrintInfo = false;
//			seq(kems); // Ekans
//		}
...
//		save("r33");
		...
		seq(NewEnemyMonSegment.any()); // next mon
		{
			KillEnemyMonSegment kems = new KillEnemyMonSegment();
			kems.attackCount[2][0] = 1; // ember
			kems.numExpGainers = 3; // level up to 15, learn bite
			kems.onlyPrintInfo = false;
			seq(kems); // Metapod
		}

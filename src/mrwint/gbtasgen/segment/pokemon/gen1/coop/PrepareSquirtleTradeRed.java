...
//    }
    ...
    seq(new EflWalkToSegment(13, 4)); // PC
    {
      ...
      seq(new EflDepositMonSegment(1, 0)); // charmeleon
      seq(new EflDepositMonSegment(0, 0)); // caterpie
      seq(new EflDepositMonSegment(0, 0)); // farfetch'd
      seq(new EflDepositMonSegment(0, 0)); // meowth
      seq(new EflWithdrawMonSegment(-1, 0)); // eevee
      seq(new EflWithdrawMonSegment(0, 0)); // mankey
      seq(new EflWithdrawMonSegment(0, 0)); // oddish
      seq(new EflWithdrawMonSegment(0, 4+1)); // clefairy

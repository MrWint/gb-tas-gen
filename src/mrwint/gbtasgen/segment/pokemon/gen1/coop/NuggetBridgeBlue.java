...
//      kems.attackCount[3][0] = 1; // bubblebeam // Wartortle
		...
		seq(new EflWalkToSegment(20, 9).setMaxBufferSize(0)); // enter route 25

    seq(new EflWalkToSegment(9, 5).setMaxBufferSize(0)); // go in grass
    seq(new EflWalkToSegment(8, 5).setMaxBufferSize(0)); // go in grass
    ...
    seq(new EflWalkToSegment(5, 5).setMaxBufferSize(0)); // go in grass
    ...
    seq(new EflWalkToSegment(2, 5).setMaxBufferSize(0)); // go in grass
    seq(new EflWalkToSegment(3, 5).setMaxBufferSize(0)); // go in grass
    seq(new EflEncounterSegment(0x7b, Move.RIGHT)); // Caterpie
    seq(new EflCatchMonSegment(2).withBufferSize(0).withExtraSkips(50));

    save("tmp3");
    load("tmp3");

    seq(new EflWalkToSegment(6, 5).setMaxBufferSize(0)); // go in grass
    seq(new EflEncounterSegment(0x94, Move.RIGHT)); // Abra

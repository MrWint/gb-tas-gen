    ...
    {
      {
        ...
        delayEfl(new SeqSegment() {
          ...
          protected void execute() {
            ...
            seqMetric(new EflCheckMoveOrderMetric(false, THUNDERBOLT));
            seqUnbounded(new EflTextSegment()); // Raichu uses THUNDERBOLT
        ...
        delayEfl(new SeqSegment() {
          ...
          protected void execute() {
            ...
            seqMetric(new EflCheckMoveDamage(true, true, 0, 35, 35, false),GREATER_EQUAL, 35);
          }
        });

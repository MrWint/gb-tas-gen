...
//    seqUnbounded(new EflWalkToSegment(23, 28, false)); // ledge
//
...
//    seq(new EflEncounterSegment(new CheckEncounterMetric(EXEGGCUTE, 25), RIGHT)); // lvl 25 for DSum
//
//    save("tmp1");
//    load("tmp1");
...
//    seq(new EflCatchSafariMonSegment().withBufferSize(0));
//
//    seqUnbounded(new EflWalkToSegment(24, 20));
...
////    seqUnbounded(new EflWalkToSegment(26, 18));
//    seq(new EflEncounterSegment(VENONAT, UP));
//    save("tmp5");
//    load("tmp5");
//    seq(new EflCatchSafariMonSegment().withBufferSize(0));
//
////    seqUnbounded(new EflWalkToSegment(27, 17));
...
//    load("sa5");
//
//    seqUnbounded(new EflWalkToSegment(18, 24));
...
//    seq(new EflCatchSafariMonSegment().withBufferSize(0));
//
//    seqUnbounded(new EflWalkToSegment(28, 4));
//    seq(new EflEncounterSegment(NIDORINO, UP));
//    save("tmp4");
    load("tmp4");
    seq(new EflCatchSafariMonSegment().withBufferSize(0)); // for Pidgeotto later

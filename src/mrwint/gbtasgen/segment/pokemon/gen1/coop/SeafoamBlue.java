...
//    seq(new EflEncounterSegment(PSYDUCK, UP));
...
//    seq(new EflEncounterSegment(ZUBAT, UP));
...
//    seq(new EflEncounterSegment(KRABBY, RIGHT));
//    save("tmp5");
//    load("tmp5");
//    seq(new EflCatchMonSegment().withBufferSize(0));
...
//    seq(new EflEncounterSegment(STARYU, LEFT));
//    save("tmp2");
//    load("tmp2");
//    seq(new EflCatchMonSegment());
...
//    seq(new EflEncounterSegment(GOLDUCK, LEFT));
//    save("tmp4");
//    load("tmp4");
//    seq(new EflCatchMonSegment().withBufferSize(0));
//    seqUnbounded(new EflWalkToSegment(11, 7)); // b3f
//    seqUnbounded(new EflWalkToSegment(11, 11));
//    seq(new EflEncounterSegment(KINGLER, DOWN));
//    save("tmp5");
//    load("tmp5");
//    seq(new EflCatchMonSegment());
//
//    seq(new EflSelectMonSegment(CHARIZARD).fromOverworld().andStrength());
...
//    seq(new EflCatchMonSegment());
//    seq(new EflFishSegment(SHELLDER));
//    seq(new EflCatchMonSegment());
//

...
import static mrwint.gbtasgen.segment.pokemon.gen1.common.Constants.PC_MON_RELEASE;
...
public class EflReleaseMonSegment extends SeqSegment {

  int mon;
	int monGoalPosition = -1;

	public EflReleaseMonSegment(int mon) {
    EflUtil.assertEfl();
	...
	@Override
	public void execute() {
    seq(new EflSelectPcMonOperationSegment(PC_MON_RELEASE));
    ...
    if (monGoalPosition <= 2)
      ...
      seqEflScrollFastA(monGoalPosition);
		seqEflButton(Move.A, PressMetric.PRESSED); // release

...
public class SlotsWheel1Metric implements StateResettingMetric {
  ...
  public SlotsWheel1Metric onlyUp() {
    allowMiddle = false;
    allowDown = false;
    return this;
  }

  public SlotsWheel1Metric onlyMiddle() {
    allowUp = false;
    allowDown = false;
    return this;
  }

  public SlotsWheel1Metric onlyDown() {
    allowUp = false;
    allowMiddle = false;
    return this;
  }
...
//    System.out.println(curGb.readMemory(0xcd3e));
    if (allowUp && (wheelPos == 0x10 || wheelPos == 0x1a || wheelPos == 0x6 || wheelPos == 0x11 || wheelPos == 0x1b || wheelPos == 0x7)) // top
      return 1;
    if (allowMiddle && (wheelPos == 0x12 || wheelPos == 0x1c || wheelPos == 0x8 || wheelPos == 0x13 || wheelPos == 0x1d || wheelPos == 0x9)) // middle
      return 1;
    if (allowDown && (wheelPos == 0x14 || wheelPos == 0x0 || wheelPos == 0xa || wheelPos == 0x15 || wheelPos == 0x1 || wheelPos == 0xb)) // bottom
      return 1;
    return 0;
	}
}

...
//			seq(new SleepSegment(200));
			...
			int mapWidth;
			{
				...
				int mapHeaderBank = rom[RomInfo.rom.mapHeaderBanksAddress+map];
				int curMapHeaderAddress = Util.getWordAt(RomInfo.rom.mapHeaderPointersAddress+2*map) + (mapHeaderBank-1)*0x4000;

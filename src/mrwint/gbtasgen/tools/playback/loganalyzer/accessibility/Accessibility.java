...
public interface Accessibility {
  ...
  public static int SAFETY_BUFFER = 4;

  public static int getM0TimeOfLine(long cycle, AccessibilityGbState gbState) {
    return (253 + SAFETY_BUFFER + (gbState.getScx(cycle) % 8) + (gbState.getWinEnabled(cycle) ? 6 : 0) + gbState.getNumSprites(cycle) * 11) * GbConstants.DOUBLE_SPEED_FACTOR;
  }
}

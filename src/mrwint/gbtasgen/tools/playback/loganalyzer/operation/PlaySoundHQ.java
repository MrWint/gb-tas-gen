...
public class PlaySoundHQ implements PlaybackOperation {
  private final TreeMap<Integer, Integer> inputMap = new TreeMap<>();
  private final int cycleCount;
  public PlaySoundHQ(GbAudio audio) {
    ...
    System.out.println("create PlaySoundHQ with " + soValues.length + " sample pairs.");
    ...
    for (int i = 0; i < soValues.length; i++) {
      ...
      inputMap.put(curCycles + 428, i+1 < soValues.length ? 1 : 0);
  ...
  public int getJumpAddress() {
    return PlaybackAddresses.PLAY_SOUND_HQ;
  }
